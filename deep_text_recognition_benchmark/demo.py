...
parser.add_argument('--image_folder', required=False, default = os.path.abspath(os.path.join('', "result/")), help='path to image_folder which contains text images')
parser.add_argument('--workers', type=int, help='number of data loading workers', default=4)
parser.add_argument('--batch_size', type=int, default=192, help='input batch size')
parser.add_argument('--saved_model', required=False, default =os.path.abspath(os.path.join('', 'deep_text_recognition_benchmark/weights/TPS-ResNet-BiLSTM-Attn.pth')) , help="path to saved_model to evaluation")
""" Data processing """
